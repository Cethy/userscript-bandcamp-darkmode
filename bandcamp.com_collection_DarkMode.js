// ==UserScript==
// @name        bandcamp.com_collection_DarkMode
// @namespace   cw.bandcamp.com_collection_DarkMode
// @match       https://bandcamp.com/*
// @grant       none
// @version     1.0
// @author      Charles
// @homepage    https://github.com/Cethy/userscript-bandcamp-darkmode
// @description Add switchable dark mode styling + auto-toggle if computer setup for preferred dark color scheme, but only on bandcamp collection pages !
// ==/UserScript==

(function() {
    'use strict';

    console.log("Hello, I'll set some dark mode styles and auto-toggle dark mode if it's your computer preferred color scheme, but only on collection pages !")

    const domParser = new DOMParser()
    const darkModeSvgString = `<svg width="34px" height="34px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
